...
export async function action({ request }: Route.ActionArgs) {
  ...
  for (const fixture of ncelFixtures) {
    if (!existingByFixtureId.has(fixture.id)) {
      ...
      existingByFixtureId.set(fixture.id, { ...newProg, fixtureId: fixture.id, status: "draft", coverImageMediaId: null, managersNotes: null, oppositionProfile: null, oppositionLineup: null, oppositionSquad: null, oppositionManagement: null, chairmansNotes: null, blakesThoughts: null, featuredPlayerId: null, featuredSponsorId: null, coverSponsorId: null, leagueNotifiedAt: null, createdAt: now, updatedAt: now });
    }
  }
