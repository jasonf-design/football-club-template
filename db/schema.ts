...
export const players = sqliteTable("players", {
  ...
  spotlightPhotoMediaId: text("spotlight_photo_media_id").references(() => media.id, { onDelete: "set null" }),
  spotlightFocalX: real("spotlight_focal_x").notNull().default(0.5),
  spotlightFocalY: real("spotlight_focal_y").notNull().default(0.5),
  sponsor1Name: text("sponsor1_name"),
  sponsor1Url: text("sponsor1_url"),
  sponsor1Description: text("sponsor1_description"),
  ...
  sponsor2Description: text("sponsor2_description"),
...
export const coachingStaff = sqliteTable("coaching_staff", {
  ...
  sponsor1Name: text("sponsor1_name"),
  sponsor1Url: text("sponsor1_url"),
  sponsor1LogoMediaId: text("sponsor1_logo_media_id").references(() => media.id, { onDelete: "set null" }),
  sortOrder: integer("sort_order").notNull().default(0),
  active: integer("active", { mode: "boolean" }).notNull().default(true),
  createdAt: createdAt(),
  updatedAt: updatedAt(),
